/* Usage:
 * This provider wraps parts of the application that need access to conversation data,
 * allowing components to interact with AI chat sessions through the provided context.
 *
 * Note: The actual AI processing occurs in the backend, with this component
 * managing the frontend state and interactions with that backend. */
